...
Usage:
    python3 src/specificity_asymmetry.py
    python3 src/specificity_asymmetry.py --output results/figures/specificity_plot.png
"""
...
from data.pairs import DEAD_METONYMY, LIVE_METONYMY, DEAD_METAPHOR, LIVE_METAPHOR
